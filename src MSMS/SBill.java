...
public class SBill extends Panel implements ActionListener {
    public static void main(String as[]) {
         ...
         * Connection con =
         * DriverManager.getConnection("jdbc:mysql://localhost:3306/Admin", "root",
         * "root");
    ...
    TextField soid, sodate, sid, mid, sName, mName, sdol, sp, oq, sbamt;
    TextArea SOT;
...

    {
        ...
        oq = new TextField(20);
        Label SBAMT = new Label("Bill Amount");
        sbamt = new TextField(20);
